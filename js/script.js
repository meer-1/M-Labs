...
function initChatWidget() {
  ...
  const rules = [
    ...
    { keys: ['team', 'staff', 'faculty members', 'javaid', 'coo', 'cto', 'imran', 'about', 'company'], reply: `Mlabs is led by founder Sajad Ahmad Mir (CEO), Javaid Ahmad Mir (Co-Founder & COO), and Mohammad Imran Mir (CTO, PhD Electrical Engineering, specializing in Electric Vehicles & Machines). Meet the full team on the <a href="${link('about')}">About page</a>.`, related: ['Mentors', 'How to apply'] },
