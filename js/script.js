...
function initProblemWidget() {
  ...
  const problems = [
    ...
    { tag: 'Programming · Arrays', text: 'Given an array of integers, find two numbers that add up to a target value. What is the optimal time complexity, and why?', answer: 'O(n): store each visited number in a hash map and check whether (target − current) has already been seen while iterating once.' },
    ...
    { tag: 'Programming · Dynamic Programming', text: 'How do you compute the nth Fibonacci number in O(n) time using only O(1) extra space?', answer: 'Track only the last two values: start a=0, b=1, then repeat (a, b) = (b, a+b) for n steps instead of storing the whole sequence.' },
...
function initChatWidget() {
  ...
  const link = (name) => {
    const map = {
      ...
      ai: inServices ? 'ai-productivity.html' : 'services/ai-productivity.html'
    };
    let href = map[name] || map.home;
    if (inServices && !['teaching', 'coding', 'exams', 'ai'].includes(name)) href = '../' + href;
    return href;
  };
  ...
  const rules = [
    ...
    { keys: ['course', 'courses', 'program', 'programs', 'offer', 'offering', 'services'], reply: `We run four core programs: <strong>Teaching</strong> (Math, Data Science &amp; AI foundations), <strong>Programming</strong> (fundamentals, DSA, and Competitive Programming), <strong>AI Productivity</strong> (Learn with AI, Build with AI), and <strong>Exam Preparation</strong> (SAT, IIT JAM, GATE, CSIR NET, JKSSB). See the <a href="${link('home')}">homepage</a> for an overview.`, related: ['Teaching', 'Programming', 'AI Productivity', 'Exams'] },
    ...
    { keys: ['programming', 'coding', 'algorithm', 'dsa'], reply: `Our Programming track runs from Programming Fundamentals through Data Structures &amp; Algorithms, with Competitive Programming (Codeforces, AtCoder, ICPC, IOI) as a specialized course. Details: <a href="${link('coding')}">Programming page</a>.`, related: ['Competitive Programming', 'Duration', 'Fees'] },
    { keys: ['ai productivity', 'learn with ai', 'build with ai', 'ai tools', 'productivity', 'copilot', 'chatgpt', 'prompt', 'prompting', 'claude'], reply: `Our AI Productivity program teaches <strong>Understand AI</strong> (what AI is and the math behind it), <strong>Learn with AI</strong> (effective prompting, using AI as a study partner), <strong>Build with AI</strong> (AI-assisted coding and shipping real projects), and the <strong>AI Productivity Toolkit</strong> (working AI into your daily workflow). Details: <a href="${link('ai')}">AI Productivity page</a>.`, related: ['Programming', 'Duration', 'Fees'] },
    { keys: ['what is ai', 'how does ai work', 'math behind ai', 'neural network', 'machine learning', 'deep learning', 'llm', 'gradient descent', 'understand ai'], reply: `Our <strong>Understand AI</strong> course covers what AI, machine learning, and deep learning actually mean, and the math intuition behind them — vectors, probability, gradient descent — including how models like ChatGPT and Claude generate text. No advanced math background required. Details: <a href="${link('ai')}">AI Productivity page</a>.`, related: ['AI Productivity', 'How to apply'] },
    { keys: ['competitive programming', 'contest', 'codeforces', 'leetcode', 'atcoder'], reply: `Competitive Programming is one of our Programming courses — contest prep for Codeforces, AtCoder, LeetCode, ICPC and IOI, plus advanced algorithms and optimization under time limits. Details: <a href="${link('coding')}">Programming page</a>.`, related: ['Programming', 'Fees', 'How to apply'] },
    ...
    { keys: ['sat'], reply: `SAT prep covers Reading, Writing and Math, with a focus on test strategy, timing, and skill building. Details: <a href="${link('exams')}">Exam Prep page</a>.`, related: ['GATE', 'IIT JAM', 'How to apply'] },
    { keys: ['jam', 'iit jam'], reply: `IIT JAM Mathematics prep covers real analysis, abstract algebra, complex analysis and linear algebra at MSc-entrance depth, taught by Sajad (himself an IIT JAM qualifier).`, related: ['CSIR NET', 'GATE', 'How to apply'] },
    { keys: ['gate'], reply: `GATE prep (Engineering Mathematics, CS, Data Science &amp; AI) covers linear algebra, calculus, probability and optimization.`, related: ['CSIR NET', 'IIT JAM', 'How to apply'] },
    { keys: ['csir', 'net', 'csir net'], reply: `CSIR NET Mathematical Sciences coaching draws directly on Sajad's own AIR 36 qualifying rank — deep coverage of pure &amp; applied math at PhD-entrance level.`, related: ['GATE', 'IIT JAM', 'How to apply'] },
    { keys: ['jkssb'], reply: `JKSSB Mathematics/Science prep is tailored for Jammu &amp; Kashmir state civil service exams, with local insights and region-specific strategy.`, related: ['Exams', 'How to apply'] },
    { keys: ['mentor', 'mentors', 'teacher', 'instructor', 'faculty', 'sajad', 'founder'], reply: `Mlabs is led by founder Sajad Ahmad Mir (PhD researcher @ NTU Singapore, CSIR-NET AIR 36). Meet him on the <a href="${link('mentors')}">Mentors page</a>.`, related: ['Team', 'How to apply'] },
    { keys: ['team', 'staff', 'faculty members', 'javaid', 'coo', 'about', 'company'], reply: `Mlabs is led by founder Sajad Ahmad Mir (CEO), with Javaid Ahmad Mir as Co-Founder & COO — the overall lead for operations, marketing, and partnerships. Meet the full team on the <a href="${link('about')}">About page</a>.`, related: ['Mentors', 'How to apply'] },
    { keys: ['collaborate', 'collaboration', 'collaborations', 'partnership', 'partnerships', 'partner', 'sponsor', 'sponsorship', 'marketing'], reply: `For collaboration, partnership, or marketing inquiries, reach out to Javaid Ahmad Mir (Co-Founder & COO) at <a href="mailto:work.mlabs@gmail.com">work.mlabs@gmail.com</a>.`, related: ['Team', 'Talk to a human'] },
    ...
    { keys: ['success', 'result', 'results', 'rate', 'placement'], reply: `Sajad has personally qualified CSIR-NET (AIR 36), IIT JAM, and GATE — the same exams we coach students for. Meet the team: <a href="${link('mentors')}">Mentors page</a>.`, related: ['Courses', 'Mentors'] },
    ...
    { keys: ['testimonial', 'review', 'reviews'], reply: `We're still early — testimonials will be added to the <a href="${link('home')}">homepage</a> as students complete our programs. In the meantime, check the <a href="${link('mentors')}">Mentors page</a> for the team's own credentials.`, related: ['Mentors', 'How to apply'] },
    ...
    { keys: ['video', 'videos', 'youtube', 'channel'], reply: `Watch free lessons and walkthroughs on our <a href="https://www.youtube.com/@mlabs-1" target="_blank" rel="noopener">YouTube channel</a> — a "Watch & Learn" section with embedded videos is on every page of the site.`, related: ['Courses', 'How to apply'] },
    { keys: ['research', 'publication', 'publications', 'paper', 'papers'], reply: `Our research background — academic focus and (soon) publications — is on the <a href="${link('research')}">Research page</a>.`, related: ['Mentors', 'How to apply'] },
    { keys: ['photo', 'photos', 'picture', 'pictures', 'gallery', 'images'], reply: `See photos from our teaching sessions and team on the <a href="${link('photos')}">Photos page</a>.`, related: ['Courses', 'Mentors'] },
...
function initWhatsAppWidget() {
  ...
  const whatsappIcon = '<svg viewBox="0 0 24 24" width="34" height="34" xmlns="http://www.w3.org/2000/svg"><path d="M12 2.002c-5.522 0-10 4.478-10 9.998 0 1.757.47 3.47 1.358 4.978L2 22l5.06-1.36a9.962 9.962 0 0 0 4.94 1.36h.001c5.522 0 10-4.478 10-9.998 0-5.52-4.478-9.998-10-9.998zm5.5 14.666c-.244.686-1.44 1.35-2.038 1.437-.552.077-1.156.105-2.598-.611-1.978-.718-3.257-2.143-3.380-2.283-.124-.141-1.164-1.32-1.166-2.521-.002-1.202.781-1.84.968-2.047.185-.208.403-.264.584-.264.18 0 .366.006.527.01.166.003.39-.062.59.472.2.534.687 1.712.748 1.84.058.128.104.215.022.355-.083.14-.126.221-.242.339-.116.118-.235.263-.34.363-.11.105-.223.203-.084.402.14.197.625.962 1.342 1.58.924.778 1.71 1.029 2.019 1.144.31.114.48.082.657-.049.176-.131.712-.826.91-1.114.2-.29.398-.238.658-.144.258.094 1.616.759 1.89.846.277.087.46.13.528.202.067.071.067.405-.178 1.091z" fill="white"/></svg>';
