...
function initChatWidget() {
  ...
  const rules = [
    ...
    { keys: ['course', 'courses', 'program', 'programs', 'offer', 'offering', 'services'], reply: `We run three core programs: <strong>Teaching</strong> (Math, Data Science &amp; AI foundations), <strong>Programming</strong> (fundamentals, DSA, and Competitive Programming), and <strong>Exam Preparation</strong> (SAT, IIT JAM, GATE, CSIR NET, JKSSB). See the <a href="${link('home')}">homepage</a> for an overview.`, related: ['Teaching', 'Programming', 'Exams'] },
    ...
    { keys: ['testimonial', 'review', 'reviews'], reply: `Real student stories are on the <a href="${link('home')}">homepage</a> testimonials carousel — covering IIT JAM, GATE, CSIR NET and competitive programming results.`, related: ['Success rate', 'How to apply'] },
